...
| `CMCA_IMG` | "quay.io/jetstack/cert-manager-cainjector:v1.16.2" |
| `CMCT_IMG` | "quay.io/jetstack/cert-manager-controller:v1.16.2" |
| `CM_ARGS` | Non scalar value, see the file for details. |
| `CMWH_IMG` | "quay.io/jetstack/cert-manager-webhook:v1.16.2" |

| Name | Current Value |
|------|---------------|
| **eda-external-packages/csi-driver/cert-manager-csi-driver.in.yaml** ||
| `EDA_CORE_NAMESPACE` | eda-system |
| `CSI_REGISTRAR_IMG` | "k8s.gcr.io/sig-storage/csi-node-driver-registrar:v2.12.0" |
| `CSI_LIVPROBE_IMG` | "registry.k8s.io/sig-storage/livenessprobe:v2.12.0" |
| `CSI_DRIVER_IMG` | "quay.io/jetstack/cert-manager-csi-driver:v0.10.1" |

| Name | Current Value |
|------|---------------|
| **eda-external-packages/eda-api-ingress-https-passthrough/api-ingress-ssl-passthrough.yaml** ||
| `EXT_DOMAIN_NAME` | "changeme.eda.dev" |
| `INT_HTTPS_PORT` | 443 |

| Name | Current Value |
|------|---------------|
| **eda-external-packages/eda-api-ingress-https/eda-api-ingress-cert.yaml** ||
| `EXT_IPV4_ADDR` | "192.168.139.35" |
| `EXT_IPV6_ADDR` | "dead:beef:cc66:0:f412:67ff:dead:beef" |
...
| `GOGS_IMG_TAG` | ghcr.io/gogs/gogs:0.13.0 |
...
| `TRUSTMGR_IMG` | "quay.io/jetstack/trust-manager:v0.15.0" |
