...
As the VMware vSphere Plugins are managed through the operator, you can use the EDA UI to create a new `VmwarePluginInstance` resource under the **Connect > VMware Plugins** menu item.
...
!!! Warning "Check the limitations of Connect at the top of this page"
