...
1. Go to the URL for the Nokia EDA server, in the form of: `https://<server>:<port>`

    /// admonition | Note
        type: subtle-note
    The default port for Nokia EDA is 9443, but consult your local administrator for your organization's URL for Nokia EDA.
    ///
...
/// admonition | Note
    type: subtle-note
You can open multiple tabs displaying the Nokia EDA UI in your browser. If at any time any of the Nokia EDA session tabs has been idle for 15 minutes, a message displays in the active tab indicating this. It offers the options to either sign out, or remain signed in. If you do not choose to remain signed in within 30 seconds, Nokia EDA automatically signs you out.
///
