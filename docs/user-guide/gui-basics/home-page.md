...
|8|Dashlets|Each dashlet displays important information about the status of the EDA application and the network it is managing. Clicking the **View** link in any dashlet opens the EDA GUI page specific to that dashlet's information.|
