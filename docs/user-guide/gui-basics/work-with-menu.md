...
The EDA menu is divided into two major groups, or panels:
...
To help you navigate efficiently to pages within the EDA GUI, you can create and share your own custom menu panels that contain and organize links to pages of most interest to you.
...
- [Custom navigation panels](../custom-navigation-panels.md)
