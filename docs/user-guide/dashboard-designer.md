...
## Dashboards page <span id="dashboards-page"></span>
...
## Dashboard designer page <span id="dashboard-designer-page"></span>
...
### The data view dashlet <span id="dashlet-dataview"></span>
...
3. Choose one of the following:
    - To create a dashboard with a list layout, go to step [4](dashboard-designer.md#dd-step-4).
    - To create a dashboard with a set of dashlets, go to step [10](dashboard-designer.md#dd-step-10).
...
19. Repeat steps [15](dashboard-designer.md#dd-step-15), [17](dashboard-designer.md#dd-step-17) and [18](dashboard-designer.md#dd-step-18) to add more dashlets to the dashboard if required, until all dashlets are configured.
...
## Creating a dashboard filter <span id="creating-dashboard-filter"></span>
...
2. For each dashlet to which a dashboard filter should apply, edit the dashlet's underlying query to include a "where" expression referring to one or more of the dashboard filters.
    ...
    /// admonition | Note
        type: subtle-note
    A sample of each filter's "where" expression is displayed on this page to help you with the correct syntax. A field also displays on this page for each dashboard filter, and you can test the filters by entering values in those fields.
    ///
...
2. Select the type of filter you are creating in the **Type** list control:
    ...
    - to add a string filter: go to step [3](dashboard-designer.md#df-step-3).
    - to add a Name/Namespace filter: go to step [5](dashboard-designer.md#df-step-5).
    - to add a custom filter: go to step [7](dashboard-designer.md#df-step-7).
...
4. Go to step [8](dashboard-designer.md#df-step-8).
...
6. Go to step [8](dashboard-designer.md#df-step-8).
...
9. Repeat step [8](dashboard-designer.md#df-step-8) for every dashlet on the dashboard that should be subject to the dashboard's filters.
