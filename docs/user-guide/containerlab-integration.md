...
Clone the [EDA Playground repository](https://github.com/nokia-eda/playground) if you haven't already and uncomment the following line in the [preferences (`prefs.mk`) file](../software-install/deploying-eda/installing-the-eda-application.md#preferences-file) :
...
[nodeUser-crd]: https://crd.eda.dev/nodeusers.core.eda.nokia.com/v1
...
[interfaceResource-crd]: https://crd.eda.dev/topolinks.core.eda.nokia.com/v1#spec.links.local.interfaceResource
