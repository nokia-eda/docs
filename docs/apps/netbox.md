...
As per the task of this example we need to create two prefixes in NetBox, one for the System IPs and one for the subnets used by our [Fabric](./fabrics.eda.nokia.com/index.md) app to assign addresses on the point-to-point interswitch links.
