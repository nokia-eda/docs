...
To know which IP address is used to send BGP traffic, EDA must have a reference to a virtual interface. If this interface is a [`SystemInterface`](-{{ ref_app_doc('routing', 'systeminterface') }}-) attached directly to the system address of the [`DefaultRouter`](-{{ ref_app_doc('routing', 'defaultrouter') }}-), a reference to this resource needs to be provided when creating the `DefaultRouteReflectorClient`.

### [`DefaultInterface`](-{{ ref_app_doc('routing', 'defaultinterface') }}-)

To know which IP address is used to send BGP traffic, EDA must have a reference to a virtual interface. If this interface is an [`DefaultInterface`](-{{ ref_app_doc('routing', 'defaultinterface') }}-) attached to a [`DefaultRouter`](-{{ ref_app_doc('routing', 'defaultrouter') }}-), a reference to this resource needs to be provided when creating the `DefaultRouteReflectorClient`.
